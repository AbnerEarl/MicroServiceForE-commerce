...
INSERT INTO tb_stock_storage VALUES ('1', '1', '27359021557', '1000');
INSERT INTO tb_stock_storage_history VALUES ('1', '1', '1000', '0');
...
CREATE TABLE `tb_shoppingcart` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `sku_id` BIGINT(20) NOT NULL COMMENT 'skuid',
  `quanty` DECIMAL(18,2) COMMENT '数量',
  `price` DECIMAL(18,2) COMMENT '单价',
  `amount` DECIMAL(18,2) COMMENT '金额',
  `create_time` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` TIMESTAMP NULL COMMENT '更新时间',
  `canceled` INT COMMENT '是否取消',
  PRIMARY KEY (`id`)
) ENGINE=INNODB DEFAULT CHARSET=utf8;
